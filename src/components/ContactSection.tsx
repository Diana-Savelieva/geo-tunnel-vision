    ...
    <section className="py-24 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          {/* CTA Section */}
          <div className="space-y-8">
            <Card className="glass-effect border-blue-500/50 bg-gradient-to-br from-blue-950/50 to-slate-900/50">
              <CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button variant="outline" className="w-full border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white py-4 text-lg">
                    Скачать презентацию
                  </Button>
                </div>
                ...
                <div className="pt-6 border-t border-slate-700">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="bg-slate-800/50 rounded-lg p-3 text-center">
                      ...
                      <div className="text-slate-400">дешевле импорта</div>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-blue-400">5 км</div>
                      <div className="text-slate-400">дальность связи</div>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-blue-400">10 м</div>
                      <div className="text-slate-400">точность GPS</div>
                    </div>
                    <div className="bg-slate-800/50 rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-blue-400">1000 м</div>
                      <div className="text-slate-400">через породу</div>
                    </div>
                  </div>
                </div>
              </CardContent>
